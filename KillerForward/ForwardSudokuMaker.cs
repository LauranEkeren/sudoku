namespace KillerForward {
    public class ForwardSudokuMaker {
        ...
        public ForwardKillerSudoku sudokuTwo(){
            ForwardKillerSudoku sudoku = new ForwardKillerSudoku();
            sudoku.addArea(24, new List<int>(){0, 1, 2, 3}); //0
            sudoku.addArea(11, new List<int>(){4, 5});
            sudoku.addArea(18, new List<int>(){6, 7, 15, 16});
            sudoku.addArea(8, new List<int>(){8, 17}); //3
            sudoku.addArea(14, new List<int>(){9, 10,11}); //4
        ...
        public ForwardKillerSudoku sudokuThree(){
            ForwardKillerSudoku sudoku = new ForwardKillerSudoku();
            
            sudoku.addArea(21, new List<int>(){0,1, 2}); //0
